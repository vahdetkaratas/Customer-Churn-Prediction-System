...
| [docs/MENU_RAIL_INNER_SCROLL_TEMPLATE.md](docs/MENU_RAIL_INNER_SCROLL_TEMPLATE.md) | Right rail + inner scroll (Arter parity) — implemented in `vercel_demo/static/index.html` |
